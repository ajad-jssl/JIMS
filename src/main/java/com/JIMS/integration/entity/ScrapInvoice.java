...
@Entity
@Table(name = "SCRAP_INVOICE_MASTER")
public class ScrapInvoice {
	...
	@Column(name = "scp_pnitems_id")
	private String scp_pnitems_id;
	...
	public String getScp_pnitems_id() {
		return scp_pnitems_id;
	}

	public void setScp_pnitems_id(String scp_pnitems_id) {
		this.scp_pnitems_id = scp_pnitems_id;
	}
